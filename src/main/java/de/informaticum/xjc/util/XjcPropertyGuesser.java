...
/**
 * Util class (technically a non-instantiable enum container) to provide some helper functions according to accessor methods of fields (getter/setter) and to the population methods
 * of classes (factory).
 */
